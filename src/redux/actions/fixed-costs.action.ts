        ...
        fixedCostsProvider
            ...
            .then((res) => {
                ...
                dispatch({
                    ...
                    payload: [res?.data?.response].concat(
                        getStore().fixedCosts.fixedCosts
                    ),
                });
            })
            .catch((err) => err);
        ...
        fixedCostsProvider
            ...
            .then((res) => {
                ...
                dispatch({
                    ...
                    payload: getStore().fixedCosts.fixedCosts.filter(
        ...
        fixedCostsProvider
            ...
            .then((res) => {
                ...
                dispatch({
                    ...
                    payload: getStore().fixedCosts.fixedCosts.map((item: FixedCostsI) =>
                        item.uuid == uuid ? {
                            ...item,
                            ...data,
