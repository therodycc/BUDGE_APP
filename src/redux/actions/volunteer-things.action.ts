        ...
        volunteerThingsProvider
            ...
            .then((res) => {
                ...
                dispatch({
                    ...
                    ].concat(getStore().volunteerThings.volunteerThings),
                });
            })
            .catch((err) => err);
    };
        ...
        volunteerThingsProvider
            ...
            .then((res) => {
                ...
                dispatch({
                    ...
                    payload: getStore().volunteerThings.volunteerThings.filter(
...
export const updateVolunteerThingsAction = (
    uuid: string,
    data: VolunteerThingsI
) => {
    return async (dispatch: Function, getStore: Function) => {
        volunteerThingsProvider
            .update(uuid, data)
            .then((res) => {
                ...
                dispatch({
                    ...
                    payload: getStore().volunteerThings.volunteerThings.map(
